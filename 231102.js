...
switch  (starWarsCharacters.eye_color === "blue") {
...
for (const femaleCharacter of femaleCharacters) {
    const characterName = femaleCharacter.name;
    characters = characters.filter(name => name !== characterName);
  }
  
  console.log("Length of 'characters' before removal: " + characters.length);
  console.log("Length of 'characters' after removal: " + characters.length);
